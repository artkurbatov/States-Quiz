...
class QuizModel {
    ...
    init() {
        ...
        quiz.append(Quiz(image: "map", answers: ["Alabama", "Mississippi", "Georgia", "South Carolina"], correctAnswer: "Alabama"))
...
//        quiz.append(Quiz(image: "test", answers: ["Kansas", "Iowa", "Colorado", "Nebraska"], correctAnswer: "Kansas"))
...
//        quiz.append(Quiz(image: "test", answers: ["Mississippi", "Arkansas", "Louisiana", "Alabama"], correctAnswer: "Mississippi"))
